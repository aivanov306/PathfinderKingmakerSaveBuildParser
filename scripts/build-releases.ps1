...
$platforms = @(
    @{Name="Windows x64"; RID="win-x64"; FileName="PathfinderKingmakerSaveParser-$Version-win-x64.zip"},
    @{Name="Linux x64"; RID="linux-x64"; FileName="PathfinderKingmakerSaveParser-$Version-linux-x64.tar.gz"},
    @{Name="macOS x64 (Intel)"; RID="osx-x64"; FileName="PathfinderKingmakerSaveParser-$Version-osx-x64.tar.gz"},
    @{Name="macOS ARM64 (Apple Silicon)"; RID="osx-arm64"; FileName="PathfinderKingmakerSaveParser-$Version-osx-arm64.tar.gz"}
)
